  ...
  <header class="p-4 bg-gray-100 text-gray-800">
    <div class="container flex justify-between h-16 mx-auto">
      ...
      <div class="items-center flex-shrink-0 hidden lg:flex">
        <a href="/login" class="self-center px-8 py-3 hover:font-bold rounded-l-lg bg-sky-600 text-gray-50" >Sign in</a>
        <a href="/register" class="self-center px-8 py-3 hover:font-bold border-l-2 border-l-white rounded-r-lg bg-sky-600 text-gray-50">Sign up</a>
      </div>
